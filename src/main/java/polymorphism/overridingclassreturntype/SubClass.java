...
public class SubClass extends SuperClass{
	...
	@Override
	//	public A commonMethod(){//possible.this method can have same return type
	//public B commonMethod(){ //Not possible. B is the dependent class of A.No parent child relation b/w A,B
...
//Note:if super class method return type is a class,the sub class method 
