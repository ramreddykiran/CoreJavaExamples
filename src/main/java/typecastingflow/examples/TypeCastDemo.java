...
public class TypeCastDemo {
	...
	public static void main(String[] args) {
		...
		//Because reference is Parent2 , instance is created for Parent3 
		p2o1.parent2M2();
		Parent1 p1o1 = (Parent3)new Parent3();//correct. Parent1,Parent2,Parent3 are allowed
		//Because reference is Parent1 , instance is created for Parent3
		p1o1.parent1M3();
		
		//Parent2 p2o3 = (Parent1)new Parent3();//compiletime error. cast should be same class or its subclass of reference type
		//Parent2 p2o3 = (Object)new Parent3();//compiletime error. Parent class (Object) is also not supported
